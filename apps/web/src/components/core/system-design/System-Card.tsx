...
export default function SystemCard({
  ...
  return (
    ...
    >
      <Card className="h-[480px] flex flex-col bg-card/50 border-border rounded-2xl overflow-hidden shadow-none transition-all duration-300 hover:border-primary/50 group">
