  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <header className="mb-10">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Testimonial Invitations</h1>
        <p className="text-slate-500 text-sm mt-2">Manage and review testimonial invitations to your colleagues and clients.</p>
      </header>
